...
_REQUESTPROTO_DUMPREQUESTPROTO_DUMPTYPES = _descriptor.EnumDescriptor(
    name='DumpTypes',
    full_name='jina.RequestProto.DumpRequestProto.DumpTypes',
    filename=None,
    file=DESCRIPTOR,
    create_key=_descriptor._internal_create_key,
    values=[
...
_sym_db.RegisterEnumDescriptor(_REQUESTPROTO_DUMPREQUESTPROTO_DUMPTYPES)
...
_REQUESTPROTO_DUMPREQUESTPROTO = _descriptor.Descriptor(
    name='DumpRequestProto',
    full_name='jina.RequestProto.DumpRequestProto',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name='path',
            full_name='jina.RequestProto.DumpRequestProto.path',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='shards',
            full_name='jina.RequestProto.DumpRequestProto.shards',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='formats',
            full_name='jina.RequestProto.DumpRequestProto.formats',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
    ...
    nested_types=[],
    enum_types=[
        _REQUESTPROTO_DUMPREQUESTPROTO_DUMPTYPES,
    ],
    serialized_options=None,
    is_extendable=False,
    syntax='proto3',
...
_REQUESTPROTO = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='dump',
            full_name='jina.RequestProto.dump',
            index=7,
            number=11,
            type=11,
            cpp_type=10,
    ...
    nested_types=[
        ...
        _REQUESTPROTO_DUMPREQUESTPROTO,
...
_REQUESTPROTO_DUMPREQUESTPROTO.fields_by_name[
    'formats'
].enum_type = _REQUESTPROTO_DUMPREQUESTPROTO_DUMPTYPES
_REQUESTPROTO_DUMPREQUESTPROTO.containing_type = _REQUESTPROTO
_REQUESTPROTO_DUMPREQUESTPROTO_DUMPTYPES.containing_type = (
    _REQUESTPROTO_DUMPREQUESTPROTO
)
...
_REQUESTPROTO.fields_by_name['dump'].message_type = _REQUESTPROTO_DUMPREQUESTPROTO
...
_REQUESTPROTO.oneofs_by_name['body'].fields.append(_REQUESTPROTO.fields_by_name['dump'])
_REQUESTPROTO.fields_by_name['dump'].containing_oneof = _REQUESTPROTO.oneofs_by_name[
    'body'
]
...
RequestProto = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        'DumpRequestProto': _reflection.GeneratedProtocolMessageType(
            'DumpRequestProto',
            (_message.Message,),
            {
                'DESCRIPTOR': _REQUESTPROTO_DUMPREQUESTPROTO,
                '__module__': 'jina_pb2'
                # @@protoc_insertion_point(class_scope:jina.RequestProto.DumpRequestProto)
            },
        ),
...
_sym_db.RegisterMessage(RequestProto.DumpRequestProto)
